.. _nils_ost.bambuddy.printer_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Auto-archive completed prints</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>IP Address / Hostname of printer</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Used to group printers and filter queue jobs</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    ...
                                    <li>H2S</li>
                                    <li>X1E</li>
                                    <li><div style="color: blue"><b>X1C</b>&nbsp;&larr;</div></li>
                                    <li>X1</li>
                                    <li>P2S</li>
                                    <li>P1S</li>
                                    <li>P1P</li>
            ...
            <tr>
                ...
                <td>
                        <div>descriptive name of printer</div>
                        <div>needs to be uniqe as it used as identifier for this module</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Serial Number of printer</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>whether a printer should exist or be deleted</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
